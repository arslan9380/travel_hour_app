          ...
          child: Row(
            children: <Widget>[
              Text(
                ...
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.grey[800], wordSpacing: 1, letterSpacing: -0.6),
              ).tr(),
              Spacer(),
              IconButton(
        ...
        children: <Widget>[
          Hero(
            ...
            child: Container(
                ...
                child: ClipRRect(borderRadius: BorderRadius.circular(5), child: CustomCacheImage(imageUrl: d.imageUrl1))),
          ),
          Align(
            ...
            child: Container(
              ...
              child: TextButton.icon(
                style: ButtonStyle(
                  shape: MaterialStateProperty.resolveWith((states) => RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(25)))),
