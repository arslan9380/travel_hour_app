...
import 'package:travel_hour/pages/interest_pages/result_page.dart';
...
class SelectInterest extends StatefulWidget {
  ...
  SelectInterest({this.selectedCity});
...
class _SelectInterestState extends State<SelectInterest> {
  String selectedInterest = Constants.luxury;
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_, index) {
                    return InkWell(
                      onTap: () {
                        setState(() {
                          selectedInterest = interest[index];
                        });
                      },
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              style: TextStyle(
                                  ...
                                  fontWeight:
                                      selectedInterest == interest[index]
                                          ? FontWeight.bold
                                          : FontWeight.normal,
                                  fontSize: selectedInterest == interest[index]
                                      ? 22
                                      : 20),
                            ),
                            Spacer(),
                            Row(
                              children: [
                                Spacer(),
                                if (selectedInterest == interest[index])
                                  Icon(
                                    Icons.check_circle,
                                    color: Colors.white,
                                    size: 28,
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => ResultPage(
                              ...
                              selectedIntreset: selectedInterest,
                            )));
              },
              child: Container(
